...
// Check Email
	var mail = /^([a-zA-Z0-9_\.\-]{5,32})+\@(([a-zA-Z0-9\-])+\.)+([a-zA-Z0-9]{2,4})+$/; 
...
// Check Birthday
	var dateformat = /^(([1-9]|[12][0-9]|3[01])(\/)([13578]|1[02]))|(([1-9]|[12][0-9])(\/)(2))|(([1-9]|[12][0-9]|3[0])(\/)([469]|11))(\/)\d{4}$/;
	if (birD == '') {
		nearby[4].innerHTML = '<span>Vui lòng chọn Birthday "<=" ngày hiện tại</span>';
		return false;
	}
	if (!dateformat.test(birD)) {
		nearby[4].innerHTML = '<span>Hãy chọn Birthday hợp lệ.<br>Example: 11/10/1995</span>';
		return false;
	}
